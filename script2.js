class Aluno {
  ...
  constructor(nome, materia, nota1, nota2, nota3,) {
  ...
  listaTabela(){
    ...
    for(let i = 0; i < this.arrayAlunos.length; i++){
      ...
      td_materia.innerText = this.arrayAlunos[i].materia;
      ...
      td_materia.classList.add('center');
...
td_media.innerText = media.toFixed(2);
  ...
  lerDados() {
    ...
    aluno.materia = document.getElementById('materia').value;
  ...
  validaCampos(aluno) {
    ...
    if(aluno.materia == ''){
      mensagem += ' - Informe a materia do Aluno \n';
    }
    if(aluno.nota1 == ''){
